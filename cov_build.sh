...
############################
# Build entservices-warehouse
echo "buliding entservices-warehouse"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-warehouse \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-warehouse --target install
echo "======================================================================================"
exit 0
