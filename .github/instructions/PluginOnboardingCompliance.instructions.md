...
- All test CI workflows (`L1-tests.yml`, `L2-tests.yml`, `L2-tests-oop.yml`) to include your plugin flag to ensure your plugin's code quality and tests are properly validated.
